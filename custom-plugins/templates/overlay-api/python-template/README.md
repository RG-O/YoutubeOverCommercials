# Python API Overlay Template

This template creates a local server API that the Live Commercial Blocker browser 
extension calls when a commercial trigger and other status updates occur.
...
1. Set to "http://localhost:64144" - Note: you can change this later in 
