# Python WebSocket Trigger Template

This template creates a local server WebSocket that the Live Commercial Blocker browser 
extension connects to and listens to for triggers when to switch to or from commercial mode.
...
1. Set "WebSocket URL" to "ws://localhost:64145" - Note: you can change this later in 
...
1. You can then see the trigger plugin template looping back and forth from commercial 
Mode in a 10 second demo loop.
