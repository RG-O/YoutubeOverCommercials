...
plugin_name = "My Dual Plugin"
plugin_id = "my-dual-plugin-ws" # Must be unique
...
async def handle_message(ws, msg):
    ...
    custom_trigger_plugin_preferences = preferences.get("pluginDualPreferences", {}).get("preferences", {}) # First time plugin users might not have this when they call for manifest
